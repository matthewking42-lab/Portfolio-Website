...
async function getCareer(): Promise<AboutContent> {
  try {
      ...
      <div className="border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-12">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="font-mono text-accent text-xs tracking-[0.18em] uppercase">Professional Profile</span>
          </div>
          <h1 className="font-mono text-4xl md:text-5xl text-gray-900 font-light">Career</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed text-[15px]">
              {career.bioParagraphs.map((para, i) => (
                <p key={i}>{para}</p>
              ))}
            </div>
